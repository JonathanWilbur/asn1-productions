...
These come from the official
[International Telecommunications Union](https://www.itu.int/en/pages/default.aspx)
specifications; more specifically, these:

* [X.680 - Abstract Syntax Notation One (ASN.1): Specification of basic notation](https://www.itu.int/rec/T-REC-X.680/en)
* [X.681 - Abstract Syntax Notation One (ASN.1): Information object specification](https://www.itu.int/rec/T-REC-X.681/en)
* [X.682 - Abstract Syntax Notation One (ASN.1): Constraint specification](https://www.itu.int/rec/T-REC-X.682/en)
* [X.683 - Abstract Syntax Notation One (ASN.1): Parameterization of ASN.1 specifications](https://www.itu.int/rec/T-REC-X.683/en)

## What is the format of these productions?

The productions use the notation described in Section 5.2 of the
[International Telecommunications Union](https://www.itu.int/en/pages/default.aspx)'s
[X.680 - Abstract Syntax Notation One (ASN.1)](https://www.itu.int/rec/T-REC-X.680/en).

Though said specification says that these productions are in Backus-Naur Form
(BNF), they are not. This is incorrect.
